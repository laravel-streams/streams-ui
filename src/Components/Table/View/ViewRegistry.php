...
use Streams\Ui\Components\Table\View\Type\Trash;
use Streams\Ui\Components\Table\View\Type\RecentlyCreated;
use Streams\Ui\Components\Table\View\Type\RecentlyModified;
