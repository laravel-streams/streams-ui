...
<nav class="flex flex-1 flex-col justify-center">
    <ul role="list" class="me-4 hidden items-center gap-x-4 lg:flex">
                    ...
                    <ul x-show="!collapsed" role="list">
                        ...
                        <li>
                            <a href="{{ $item->getUrl() }}"
                                ...
                                class="{{ $item->isActive() ? 'bg-gray-50 text-primary-600' : 'text-gray-700 hover:text-primary-600 hover:bg-gray-50' }} group flex w-full items-center gap-x-3 rounded-md p-2 leading-6 font-semibold">
                                @if ($label)
