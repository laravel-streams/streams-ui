                                ...
                                <ul x-show="!collapsed" role="list">
                                    ...
                                    <li>
                                        <a href="{{ $item->getUrl() }}"
                                            ...
                                            class="{{ $item->isActive() ? 'bg-gray-50 text-primary-500' : 'text-gray-700 hover:text-primary-500 hover:bg-gray-50' }} group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
