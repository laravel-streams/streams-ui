        ...
        <div class="flex justify-between flex-1 sm:hidden">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <span class="py-1 px-3 text-sm font-bold text-black border-2 border-black inline-block cursor-default text-red-500">{{ $element }}</span>
                @endif
                ...
                @if (is_array($element))
                    @foreach ($element as $page => $url)
                        @if ($page == $paginator->currentPage())
                            <span class="py-1 px-3 text-sm font-bold text-black border-2 border-black inline-block cursor-default text-red-500">{{ $page }}</span>
                        @else
